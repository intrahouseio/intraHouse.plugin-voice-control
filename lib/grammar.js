 ...
 *	@param {Boolen} nominative - именительный падеж - беглые гласные не исключать
 ...
 **/
function getKeyWords(str, lang, nominative) {
  ...
  arr.forEach((item, idx) => {
    if (isDigit(item)) {
      ...
      permutations = 1;
    } else if (!nominative && isFluentVowels(item, lang)) {
